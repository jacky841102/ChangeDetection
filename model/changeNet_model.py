...
def change_layer(input_channels):
    return nn.Sequential(
...
def buildCostVolumePhotometric(left_image, right_image, KRKiUV_T, KT_T):
...
class ChangeNet(nn.Module):
    ...
    def forward(self, left_image, right_image, KRKiUV_T, KT_T):
        ...
        # left_image *= 0.0
        plane_sweep_volume = buildCostVolumePhotometric(left_image, right_image, KRKiUV_T, KT_T)
